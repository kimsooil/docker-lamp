...
MODEL_API_STATE = ENV('MODEL_API_SUBPATH', default='Nebraska')

API_DEFAULT_COUNTIES = ENV.list('DJANGO_API_DEFAULT_COUNTIES', default=['Lincoln'])
API_DEFAULT_MAP_X_COORD = ENV.float('DJANGO_API_DEFAULT_MAP_X_COORD', default=41.5)
API_DEFAULT_MAP_Y_COORD = ENV.float('DJANGO_API_DEFAULT_MAP_Y_COORD', default=-100.0)
